# backend/helpers/AuthenticationHelper.py
...
# Create module-level variables instead of class variables
...
async def get_current_labeler_user(current_user: User = Depends(get_current_active_user)) -> User:
    """Check if the current user is a labeler"""
